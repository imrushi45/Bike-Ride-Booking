...
<div class="toast" style="background: green;width: 50%;margin-left: 25%;position: absolute;top: 30vh;border-radius: 8px;padding: 30px;">
    <div class="toast-header" style="color: #ddd; text-align: center; font-weight: bolder;font-size: 20px;">
      You have Successfully Hired <span style="color:#ffffff;"><?php echo $name=$_GET['name']; ?></span> as Your Driver
    </div>
      ...
      <script>
          $(document).ready(function(){
             ...
             $.ajax({
               ...
               type: "POST",
               data:{driverId:driverId,drivername:drivername, pickupLoc:pickupLoc,returnLoc:returnLoc,pickupDate:pickupDate,returnDate:returnDate,fullname:fullname,email:email,contact:contact,charges:charges},
